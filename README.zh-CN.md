...
5. **Notification path：** 远程 Claude Code hooks、Codex notify、opencode idle 和 Antigravity stop 事件通过 `cc-clip-hook` / `cc-clip notify` / plugin → SSH tunnel → 本地 daemon → macOS Notification Center 或 cmux。
