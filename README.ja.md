...
5. **Notification path:** リモートの Claude Code hooks、Codex notify、opencode idle、Antigravity stop イベントは、`cc-clip-hook` / `cc-clip notify` / plugin → SSH tunnel → ローカル daemon → macOS Notification Center または cmux へ流れます。
